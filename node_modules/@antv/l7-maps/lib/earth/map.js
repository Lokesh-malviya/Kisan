...
var L7EarthService = (_dec = (0, _inversify.injectable)(), _dec(_class = /*#__PURE__*/function (_ref) {
  ...
  function L7EarthService() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "version", _version.Version.GLOBEL);
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleCameraChanged", function (e) {
      ...
      var _this$config$offsetCo = _this.config.offsetCoordinate,
          offsetCoordinate = _this$config$offsetCo === void 0 ? true : _this$config$offsetCo; // resync
  ...
  (0, _createClass2.default)(L7EarthService, [{
    ...
    value: function rotateY(option) {
      var _ref2 = option || {},
          ...
          _ref2$reg = _ref2.reg,
          reg = _ref2$reg === void 0 ? 0.01 : _ref2$reg; // TODO: 让旋转方法与
