  ...
  function BaseMapService() {
    ...
    (0, _defineProperty2.default)(this, "handleCameraChanged", function (e) {
      var _this$map$getCenter = _this.map.getCenter(),
          ...
          lng = _this$map$getCenter.lng; // Tip: 统一触发地图变化事件


      _this.emit('mapchange'); // resync
  ...
  (0, _createClass2.default)(BaseMapService, [{
    ...
    value: function getMapStyle() {
      try {
        ...
        // @ts-ignore
        var styleUrl = (_this$map$getStyle$sp = this.map.getStyle().sprite) !== null && _this$map$getStyle$sp !== void 0 ? _this$map$getStyle$sp : ''; // 将 Mapbox 返回的样式字符串转成传入 style 保持一致
    ...
    value: function updateCoordinateSystemService() {
      var _this$config$offsetCo = this.config.offsetCoordinate,
          offsetCoordinate = _this$config$offsetCo === void 0 ? true : _this$config$offsetCo; // set coordinate system
