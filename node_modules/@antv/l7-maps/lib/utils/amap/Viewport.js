...
var Viewport = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Viewport, [{
    ...
    value: function syncWithMapCamera(mapCamera) {
      ...
      var rotationInRadians = (360 - bearing) * DEGREES_TO_RADIANS; // 计算透视投影矩阵 projectionMatrix

      _glMatrix.mat4.perspective(this.projectionMatrix, fov, aspect, near, far); // 计算相机矩阵 viewMatrix
